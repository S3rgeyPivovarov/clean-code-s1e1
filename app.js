...
const createNewTaskElement = function (taskString) {
  ...
  label.className = "todo-list__task-caption";

  //Each elements, needs appending
  checkBox.type = "checkbox";
  checkBox.ariaLabel = "It's completed?";
  checkBox.className = "todo-list__task-checkbox";

  editInput.type = "text";
  editInput.className = "todo-list__task-caption_edit";
  editInput.ariaLabel = "input task name";
  ...
  deleteButtonImg.className = "todo-list__img-delete-button";
  deleteButton.appendChild(deleteButtonImg);

  listItem.className = "todo-list__task-container";
